    ...
    return (
        <main className="mt-20 max-w-5xl mx-auto">
            <section className="flex flex-col md:flex-row-reverse mb-10">
                <div className="md:hidden mx-auto"><img src={Avatar} alt="" /></div>
                <div>
                <div className="hidden md:block float-right w-1/3 mt-8 ms-8"><img src={Avatar} alt="" /></div>
                    ...
                    <p className="flex flex-col gap-2 text-light-gray mt-6">
                        <span>1995｜臺灣高雄人｜現居新北市<br />活潑外向、充滿好奇心の巨蟹北漂青年</span>
                        <span>擁有設計、攝影的專業經驗，活躍於網路行銷經手過數百間廠商，將全媒體的素材設計發揮到淋漓盡致。</span>
                        <span>除了專業領域的深耕，也樂於學習新事物與接受挑戰，曾於公司擔任年度設計素材講師，從中獲得如何與他人分享專業經驗並協助其解決問題的方式。</span>
                        <span>傾聽跟溝通是合作中讓我最重視的部分，相信透過不同意見的交流與分享，才能讓成果以完美的樣子呈現。</span>
                        <span>平時喜歡關注藝文、影視與網路媒體等流行文化，最近也在研究自媒體的經營，期待在水瓶時代中，能夠多元化的發展，找出自己不同的價值，創造出更豐富的作品。</span>
                    </p>
                </div>
            </section>
